                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control-rounded form-control" name="descricao" value="<?php echo($detalhes['anexo']->descricao);?>">
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="categoria">Selecione a Categoria</label>
                                     <select class="form-control-rounded form-control" name="categoria" id="categoria">
										 <?php foreach ($detalhes['categorias'] as $categoria): ?>
										 	<?php if($detalhes['anexo']->id_categoria == $categoria->id){?>
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control-rounded form-control" name="documento" value="<?php echo($detalhes['anexo']->documento);?>">
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-12 col-md-2">
                                    ...
                                    <input type="text" class="form-control-rounded form-control" name="prancha" value="<?php echo($detalhes['anexo']->prancha);?>"/>
                                </div>
                                <div class="col-6 col-md-2">
                                        <label for="escala">Escala</label>
                                        <input type="text"
                                            class="form-control-rounded form-control"
                                            name="escala" id="escala" value="<?php echo($detalhes['anexo']->escala);?>">
                                    </div>
                                    <div class="col-6 col-md-2">
                                        ...
                                        $detalhes['anexo']->status == 0 ? $status0 = 'selected' :  '';
                                        $detalhes['anexo']->status == 1 ? $status1 = 'selected' :  '';
                                        $detalhes['anexo']->status == 2 ? $status2 = 'selected' :  '';
                                        $detalhes['anexo']->status == 3 ? $status3 = 'selected' :  '';
                                    ...
                                    <div class="col-12 col-md-2">
                                        <label for="categoria">Previsto</label>
                                            <input type="text"
                                            class="form-control-rounded form-control"
                                            name="previsto" id="previsto" value="<?php echo($detalhes['anexo']->previsto);?>">
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <label for="link">Link</label>
                                            <input type="text"
                                            class="form-control-rounded form-control"
                                            name="link" id="link" value="<?php echo($detalhes['anexo']->link);?>">
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <textarea  rows="3"
                                            ...
                                            ><?php echo($detalhes['anexo']->detalhe);?></textarea>
                                            <input type="hidden" class="form-control-rounded form-control" name="idprojeto" id="idprojeto">
                                            <input type="hidden" class="form-control-rounded form-control" name="idanexo" id="idanexo" value="<?php echo($detalhes['anexo']->id);?>">
                                            <input type="hidden" class="form-control-rounded form-control" name="url" id="url" value="<?php echo($detalhes['anexo']->arquivo);?>">
                                    </div>
                            </div>
                            <div class="row">
                                <div class="col-12 text-right">
                                    <a href="{{ url('/projeto/') }}/<?php echo $_SESSION['idprojeto'];  ?>/anexos" class="btn btn-outline-primary">Voltar Projetos</a>
                                    <button type="button" class="btn btn-primary" id="editargravar">Atualizar Projeto</button>
                                </div>
                            </div>
