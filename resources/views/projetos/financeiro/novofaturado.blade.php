            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <input type="hidden" name="idorcamento" value="<?php echo($item->id);?>">
                        <div class="form-group row">
                            <div class="col-12 col-md-4">
                                <label for="descricao">Descrição</label>
                                <input type="text" class="form-control-rounded form-control" name="descricao" value="<?php echo($item->descricao);?>">
                            </div>
                            <div class="col-12 col-md-4">
                                <label for="categoria">Categoria</label>
                                <input type="text"  class="form-control-rounded form-control" disabled value="<?php echo($item->nome);?>">
                                <input type="hidden" name="categoria" id="categoria"  class="form-control-rounded form-control"  value="<?php echo($item->id_categoria);?>">
                            </div>
                            <div class="col-12 col-md-4">
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    <a href="{{ url('/projeto/') }}/<?php echo $_SESSION['idprojeto'];  ?>/orcamentos/listagem/?categoria=<?php echo $item->id_categoria;  ?>" class="btn btn-outline-primary">Voltar Orcamento</a>
                                    <button type="button" class="btn btn-primary" id="btncriarFaturamento">Adicionar Pagamento</button>
                                </div>
                            </div>
