                                                ...
                                                <form action="#" class="formulario-escolha" id="form<?php echo($itens[0]['id_pai']);?>">
                                                    ...
                                                    <?php foreach ($itens as $value):?>
                                                        <div class="col-12 col-md-4">
                                                           ...
                                                           <strong>Link:</strong><br /> <a href="<?php echo($value['link']);?>" class="btn btn-default"  target="_blank">Clique aqui</a></p>
                                                            </label>
                                                        </div>
                                                        <?php endforeach; ?>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <?php foreach ($itensreprovado as $valuereprovado):?>
                                                            <div class="col-12 col-md-4">
                                                                ...
                                                                <strong>Link:</strong><br /> <a href="<?php echo($valuereprovado['link']);?>" class="btn btn-default" href="#">Clique aqui</a></p>
                                                                <h2>
                                                                    Motivo:<br />
                                                 ...
                                                 <div class="card-body">
                                                    ...
                                                    <?php foreach ($itensaprovado as $valueaprovados):?>
                                                        <div class="col-12 col-md-4">
                                                            ...
                                                            <strong>Link:</strong><br /> <a href="<?php echo($valueaprovados['link']);?>" target="_blank" class="btn btn-default">Clique aqui</a></p>
                                                            </div>
                                                        </div>
                                                        <?php endforeach; ?>
                                                    </div>
