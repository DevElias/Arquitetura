            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="modal-footer">
                        ...
                        <span type="button" class="btn btn-primary" id="gravarServico">Criar Item</span>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#btnAdd').click(function() {
            ...
            newSection.children(':first').children(':nth-child(3)').children(':nth-child(2)').attr('id', 'valorunitario' + newNum).attr('name', 'valorunitario' + newNum).val('').val('').mask('#.##0,00', {reverse: true});
